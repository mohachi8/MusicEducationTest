...
enum class BlockDataModel(
    ...
    BLOCK01T("block01t", BlockType.MUSIC, R.drawable.star_01, R.raw.ttls_01),
    BLOCK02T("block02t", BlockType.MUSIC, R.drawable.star_02, R.raw.ttls_02),
    BLOCK03T("block03t", BlockType.MUSIC, R.drawable.star_03, R.raw.ttls_03),
    BLOCK04T("block04t", BlockType.MUSIC, R.drawable.star_04, R.raw.ttls_04),
    BLOCK05T("block05t", BlockType.MUSIC, R.drawable.star_05, R.raw.ttls_05),
    BLOCK06T("block06t", BlockType.MUSIC, R.drawable.star_06, R.raw.ttls_06),
    BLOCK09T("block09t", BlockType.MUSIC, R.drawable.star_01, R.raw.ttls_09),
    BLOCK10T("block10t", BlockType.MUSIC, R.drawable.star_02, R.raw.ttls_10),
    BLOCK11T("block11t", BlockType.MUSIC, R.drawable.star_03, R.raw.ttls_11),
    BLOCK12T("block12t", BlockType.MUSIC, R.drawable.star_04, R.raw.ttls_12),
